...
export class ApplyTransparentButtonClassDirective implements OnInit {
  ...
  constructor(
    ...
    el.nativeElement.className += ' w-full px-16 py-4 bg-transparent border-2 border-white border-solid font-bold text-white uppercase rounded-lg mt-2 opacity-75';
  }
