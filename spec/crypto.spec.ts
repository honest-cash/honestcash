import * as crypto from "../src/core/lib/crypto";

describe("crypto", () => {
  it("calculates correct hashes", () => {
    const hash = crypto.calculatePasswordHash("test@email.com", "testpassord");
    const hash2 = crypto.calculatePasswordHash("test@email.com", "testpassord2");
